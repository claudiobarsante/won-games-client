...
export type LogoProps = {
  ...
  id?: string; // -- to avoid problems when hinding more than one logo in the same page, each logo has it's own unique ID
};
  ...
  <S.Container color={color} size={size} hideOnMobile={hideOnMobile}>
    ...
    >
      ...
      <path
        ...
        fill="currentColor" //get color from S.Container  set to currentColor
      />
      <defs>
        <linearGradient
          id={`paint_linear_${id}`}
